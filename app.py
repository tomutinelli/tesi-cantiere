...
# --- STILE CSS MINIMAL CON BORDI E RADIO IN VERDE PASTELLO ---
st.markdown("""
<style>
    ...
    /* Card minimaliste con bordo in verde pastello delicato */
    .minimal-card {
    ...
    /* Forzatura colore verde pastello per i radio button di Streamlit (BaseWeb) */
    div.stRadio input[type="radio"] {
        accent-color: #82e0aa !important;
    }
    div.stRadio [data-baseweb="radio"] div {
        border-color: #82e0aa !important;
    }
    div.stRadio [data-baseweb="radio"] [aria-checked="true"] div {
...
with st.expander("Note metodologiche e specifiche di utilizzo"):
    ...
    Questo strumento calcola l'impronta di carbonio (in kg di anidride carbonica equivalente) in fase di progetto incrociando i dati di consumo giornaliero con il database LCI di riferimento. 
