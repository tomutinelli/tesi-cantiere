...
# --- STILE CSS CORRETTO PER FORZARE IL VERDE PASTELLO ---
st.markdown("""
<style>
    ...
    /* Card minimaliste con bordo in verde pastello forzato */
    div.minimal-card {
    ...
    /* Radio button: colorazione cerchietto e pallino interno in verde pastello */
    .stRadio div[role="radiogroup"] label div[data-testid="stMarkdownContainer"] p {
        color: #1f2937 !important;
    }
    
    /* Forza il colore del pallino radio di Streamlit */
    input[type="radio"] {
