...
if file_cantiere:
    try:
        ...
        date_range = date_range = st.date_input(
        ...
        if df_filtrato.empty:
            ...
            # Funzione di supporto per generare la figura in base alla modalità scelta
            ...
            # Pulsanti di esportazione dati per il totale
            ...
            for idx, param in enumerate(parametri_presenti):
                ...
                with col_grafici[idx % 2]:
                    ...
                    # Pulsanti di esportazione specifici per categoria
